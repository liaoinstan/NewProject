    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.query:
                ...
                // 创建DatabaseHelper对象
                MySQLiteOpenHelper dbHelper4 = new MySQLiteOpenHelper(DBActivity.this, "test_carson", 2);
                // 调用getWritableDatabase()方法创建或打开一个可以读的数据库
            ...
            case R.id.modify:
                ...
                MySQLiteOpenHelper dbHelper2 = new MySQLiteOpenHelper(DBActivity.this, "test_carson", 2);
            ...
            case R.id.delete:
                ...
                // 创建DatabaseHelper对象
                MySQLiteOpenHelper dbHelper3 = new MySQLiteOpenHelper(DBActivity.this, "test_carson", 2);
                // 调用getWritableDatabase()方法创建或打开一个可以读的数据库
            ...
            case R.id.delete_database:
                ...
                MySQLiteOpenHelper dbHelper5 = new MySQLiteOpenHelper(DBActivity.this, "test_carson", 2);
